...
function RenderText(props) {
	...
	props.contentText.split("\n").forEach((e, index) => {
		arrayText.push(<p key={index}>{e}</p>);
	});
	return <div style={props.styles}>{arrayText}</div>;
}
			...
			<Grid item xs={12} md={6}>
				<Grid container spacing={1} direction="column" alignItems="center">
					<Grid item>
						...
						>
							<Button key="1" style={Css.buttonTest(false)}>
								老薑
							</Button>
							<Button key="2" style={Css.buttonTest(false)}>
								紅棗
							</Button>
							<Button key="3" style={Css.buttonTest(false)}>
								四合一
							</Button>
							<Button key="4" style={Css.buttonTest(false)}>
								玫瑰
							</Button>
						</ButtonGroup>
					</Grid>
					<Grid item>
						<ButtonGroup color="primary">
							<Button value="5" style={Css.buttonTest(false)}>
								蔓越梅
							</Button>
							<Button value="6" style={Css.buttonTest(false)}>
								金桔
							</Button>
							<Button value="7" style={Css.buttonTest(false)}>
								四物
							</Button>
							<Button value="8" style={Css.buttonTest(false)}>
								綜合
							</Button>
						</ButtonGroup>
					</Grid>
				...
				<Grid container spacing={0}>
					...
					<Grid item xs={12} style={Css.gridOriginPrice}>
						<Typography variant="h5" component="p" style={Css.text2}>
							原價 <span style={{ textDecoration: "line-through" }}>$200</span>{" "}
							售價 $190
						</Typography>
					</Grid>
					<Grid item xs={12} style={Css.gridGroupPrice}>
						...
						<Typography
							variant="subtitle1"
							component="p"
							style={Css.body1("-5px auto", "#9e9e9e", "17px")}
						>
							個人購買達團購量，以團購價計算
						</Typography>
					</Grid>
