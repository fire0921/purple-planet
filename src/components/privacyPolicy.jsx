...
export default function Privacy() {
	return(
		<div>
			...
			<p>Effective date: June 27, 2019</p>


			<p>purple-planet ({"\"us\""}, {"\"we\""}, or {"\"our\""}) operates the https://localhost:5000 website (hereinafter referred to as the {"\"Service\""}).</p>

			<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy  for purple-planet is created with the help of the <a href="https://www.privacypolicies.com/free-privacy-policy-generator/">PrivacyPolicies.com Privacy Policy Generator</a>.</p>
			...
			<p>purple-planet uses the collected data for various purposes:</p>    
			<ul>
			...
			<p>purple-planet will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

			<h2>Disclosure Of Data</h2>

			<h3>Legal Requirements</h3>
			<p>purple-planet may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
			<ul>
				<li>To comply with a legal obligation</li>
				<li>To protect and defend the rights or property of purple-planet</li>
			...
			<ul>
				<li>By email: firebellyppt170326@gmail.com</li>
